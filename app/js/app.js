...
(function () {
    ...
    app.appLoad('full', function (e) {
        ...
        $(document).on('submit', '.callback-form', function (e) {
            ...
            var $form = $(this);
            var $formAnswer = $form.find('.form-answer');
            ...
            $.post('http://portfolio.gamm.biz/eglc/mail.php', data, function (response) {
                var $formResponseContainer = $('<div class="fw-mt-30 fw-width-1-1 fw-bg-color-white fw-border-box fw-pt-5 fw-pb-5 fw-pl-5 fw-pr-5"></div>');
